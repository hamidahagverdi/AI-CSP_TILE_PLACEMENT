"""
This module contains the Landscape class, which forms the foundation of the tile placement puzzle.
The Landscape class manages:

Reading and interpreting landscape data from text input
Tracking the grid layout, tile inventory, and required bush visibility goals
Dividing the landscape into 4x4 sections for proper tile placement
Offering helper functions for data parsing and handling incomplete information

This class works closely with the Square class, which represents individual placeable areas within the broader landscape.
"""
